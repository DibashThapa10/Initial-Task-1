...
class HomeScreen extends StatelessWidget {
  ...
  Widget _buildMedia(BuildContext context) {
    ...
    switch (mediaData.type) {
      ...
      case 'Video':
        return BlocProvider(
          create: (_) => MediaBloc(mediaData.value)..add(InitializeVideo(mediaData.value)),
          child: const VideoWidget(),
        );
      case 'Url':
        return InkWell(
          // onTap: () => launchUrl(Uri.parse(mediaData.value)),
          child: Text(mediaData.value, style: const TextStyle(color: Colors.blue)),
        );
      default:
